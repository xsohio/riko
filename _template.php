<?php
// ============================================================
//  _template.php — Template Dasar Halaman Admin
//  CARA PAKAI: Copy file ini, ganti $page_title, $active_page,
//  dan isi konten di bagian <!-- KONTEN -->.
// ============================================================
session_start();
include "config.php";
...
$active_page = ''; // Sesuaikan: siswa | pembimbing | perusahaan | penempatan | dst.
?>
<!DOCTYPE html>
<html lang="id">
<head>
  <meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/>
  <title><?php echo $page_title; ?> — Admin PKL</title>
  ...
  <style>
    ...
    .sidebar{width:260px;min-height:calc(100vh - 64px);background:#0f172a;border-right:1px solid rgba(45,212,191,.15);
      padding:24px 0;position:fixed;top:64px;left:0;bottom:0;overflow-y:auto;transition:width .3s,transform .3s;z-index:90;}
...
<main class="main-content" id="mainContent">
  ...
  <!-- ==================== KONTEN ==================== -->
  <!-- Ganti bagian ini sesuai kebutuhan halaman -->
  ...
  <div class="card">
    <p style="text-align:center;padding:40px 0;color:#475569;">
      <i class="fas fa-tools" style="font-size:2rem;margin-bottom:12px;display:block;"></i>
      Konten halaman <strong style="color:#2dd4bf;"><?php echo $page_title; ?></strong> akan ditampilkan di sini.
    </p>
  </div>
