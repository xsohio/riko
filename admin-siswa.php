...
<head>
  ...
  <title>Data Siswa — Admin PKL</title>
...
<main class="main-content" id="mainContent">
  ...
  <div class="page-header">
    <h2><i class="fas fa-user-graduate" style="color:#2dd4bf;"></i> Data Siswa</h2>
    <a href="admin-users.php" class="btn btn-primary btn-sm"><i class="fas fa-user-plus"></i> Tambah Siswa</a>
  </div>

  <div class="card" style="margin-bottom:20px;">
    <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center;">
      <div class="search-bar"><i class="fas fa-search"></i><input type="text" placeholder="Cari nama siswa..."/></div>
      <select class="form-control" style="width:auto;padding:9px 14px;">
        <option>Semua Kelas</option><option>XII RPL 1</option><option>XII RPL 2</option><option>XII TKJ</option>
      </select>
  ...
  <div class="card">
    <div class="table-wrapper">
      <table>
        <thead><tr><th>#</th><th>Nama Siswa</th><th>Kelas</th><th>Perusahaan PKL</th><th>Status</th><th>Aksi</th></tr></thead>
        <tbody>
          <tr><td>1</td><td><i class="fas fa-user" style="color:#2dd4bf;margin-right:8px;"></i>Andi Pratama</td><td>XII RPL 1</td><td>PT. Maju Bersama</td><td><span class="pill pill-green">Aktif</span></td><td><a href="#" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a> <a href="#" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td></tr>
          <tr><td>2</td><td><i class="fas fa-user" style="color:#2dd4bf;margin-right:8px;"></i>Budi Santoso</td><td>XII RPL 2</td><td>CV. Teknologi Nusantara</td><td><span class="pill pill-yellow">Selesai</span></td><td><a href="#" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a> <a href="#" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td></tr>
          <tr><td>3</td><td><i class="fas fa-user" style="color:#2dd4bf;margin-right:8px;"></i>Citra Dewi</td><td>XII TKJ</td><td>PT. Digital Solusi</td><td><span class="pill pill-green">Aktif</span></td><td><a href="#" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a> <a href="#" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td></tr>
        </tbody>
      </table>
    </div>
    <div class="pagination" style="margin-top:16px;">
      <a class="page-btn active">1</a><a class="page-btn">2</a><a class="page-btn">3</a><a class="page-btn"><i class="fas fa-chevron-right"></i></a>
    </div>
  </div>
</main>
</div>
