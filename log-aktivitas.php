...
<head>
  ...
  <title>Log Aktivitas — Admin PKL</title>
...
<main class="main-content" id="mainContent">
  ...
  <div class="page-header">
    <h2><i class="fas fa-history" style="color:#94a3b8;"></i> Log Aktivitas</h2>
    <button class="btn btn-danger btn-sm" onclick="return confirm('Hapus semua log?')"><i class="fas fa-trash"></i> Hapus Log</button>
  </div>

  <div class="card">
    <div class="table-wrapper">
      <table>
        <thead><tr><th>#</th><th>Pengguna</th><th>Aktivitas</th><th>IP Address</th><th>Waktu</th><th>Status</th></tr></thead>
        <tbody>
          <tr><td>1</td><td><span class="pill pill-green">Admin</span></td><td>Login berhasil</td><td>192.168.1.5</td><td>07 Apr 2025, 08:00</td><td><span class="pill pill-green">Berhasil</span></td></tr>
          <tr><td>2</td><td><span class="pill pill-green">Admin</span></td><td>Tambah user: Andi Pratama</td><td>192.168.1.5</td><td>07 Apr 2025, 08:15</td><td><span class="pill pill-green">Berhasil</span></td></tr>
          <tr><td>3</td><td><span class="pill pill-blue">Siswa</span></td><td>Upload laporan PKL</td><td>192.168.1.10</td><td>07 Apr 2025, 09:30</td><td><span class="pill pill-green">Berhasil</span></td></tr>
          <tr><td>4</td><td><span class="pill pill-yellow">Pembimbing</span></td><td>Setujui jurnal harian</td><td>192.168.1.20</td><td>07 Apr 2025, 10:00</td><td><span class="pill pill-green">Berhasil</span></td></tr>
          <tr><td>5</td><td><span class="pill pill-red">Unknown</span></td><td>Gagal login (password salah)</td><td>10.0.0.99</td><td>07 Apr 2025, 11:45</td><td><span class="pill pill-red">Gagal</span></td></tr>
        </tbody>
      </table>
    </div>
  </div>
