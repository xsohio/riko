...
<head>
  ...
  <title>Profil Saya — Admin PKL</title>
...
<main class="main-content" id="mainContent">
  ...
  <div class="page-header">
    <h2><i class="fas fa-user-circle" style="color:#2dd4bf;"></i> Profil Saya</h2>
    
  </div>

  <div style="display:grid;grid-template-columns:280px 1fr;gap:20px;">
    <div class="card" style="text-align:center;padding:32px 24px;">
      <div style="width:80px;height:80px;border-radius:50%;background:linear-gradient(135deg,#2dd4bf,#0ea5e9);display:flex;align-items:center;justify-content:center;font-weight:700;font-size:2rem;color:#0f172a;margin:0 auto 16px;"><?php echo strtoupper(substr($_SESSION['user']['username'],0,1)); ?></div>
      <h3 style="color:#e2e8f0;"><?php echo htmlspecialchars($_SESSION['user']['username']); ?></h3>
      <div class="pill pill-green" style="margin:8px auto;width:fit-content;">Administrator</div>
      <p style="margin-top:12px;font-size:.8rem;">Terakhir login: 07 Apr 2025, 08:00</p>
    </div>
    <div style="display:flex;flex-direction:column;gap:20px;">
      <div class="card">
        <h3 style="margin-bottom:20px;"><i class="fas fa-user-edit" style="color:#2dd4bf;margin-right:8px;"></i>Informasi Akun</h3>
        <div class="form-group"><label>Username</label><input type="text" class="form-control" value="<?php echo htmlspecialchars($_SESSION['user']['username']); ?>"/></div>
        <div class="form-group"><label>Email</label><input type="email" class="form-control" value="admin@pkl.sch.id"/></div>
        <div class="form-group"><label>Role</label><input type="text" class="form-control" value="Administrator" readonly style="color:#64748b;cursor:not-allowed;"/></div>
        <button class="btn btn-primary btn-sm"><i class="fas fa-save"></i> Simpan Perubahan</button>
      </div>
      <div class="card">
        <h3 style="margin-bottom:20px;"><i class="fas fa-key" style="color:#ef4444;margin-right:8px;"></i>Ubah Password</h3>
        <div class="form-group"><label>Password Lama</label><input type="password" class="form-control" placeholder="••••••••"/></div>
